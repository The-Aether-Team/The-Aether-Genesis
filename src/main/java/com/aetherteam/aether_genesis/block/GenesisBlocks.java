...
public class GenesisBlocks {
    ...
    public static final RegistryObject<Block> AETHER_CRAFTING_TABLE = register("skyroot_crafting_table", () -> new BlockAetherCraftingTable(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> HOLYSTONE_FURNACE = register("holystone_furnace", () -> new BlockHolystoneFurnace(Block.Properties.of(Material.STONE, MaterialColor.STONE).strength(2.5F).requiresCorrectToolForDrops()));
