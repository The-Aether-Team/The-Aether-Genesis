...
public class GenesisFoods {
    ...
    public static final FoodProperties WARPED_CHOCOLATES = new FoodProperties.Builder().fast().nutrition(12).saturationMod(0.48F).build();
    ...
    public static final FoodProperties PINK_SWET_LOLLIPOP = new FoodProperties.Builder().fast().nutrition(20).saturationMod(0.8F).build();
