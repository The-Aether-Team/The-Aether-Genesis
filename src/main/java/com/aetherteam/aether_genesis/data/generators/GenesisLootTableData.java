...
import com.aetherteam.aether_genesis.data.generators.loot.GenesisSelectorLoot;
...
public class GenesisLootTableData {
    public static LootTableProvider create(PackOutput output) {
        return new LootTableProvider(output, GenesisLoot.IMMUTABLE_LOOT_TABLES, List.of(
                ...
                new LootTableProvider.SubProviderEntry(GenesisSelectorLoot::new, LootContextParamSets.SELECTOR)
        ));
    }
}
