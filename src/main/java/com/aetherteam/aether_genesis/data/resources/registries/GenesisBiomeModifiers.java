...
public class GenesisBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_GREEN_AERCLOUD_8, new BiomeModifiers.AddFeaturesBiomeModifier(
                context.lookup(Registries.BIOME).getOrThrow(GenesisTags.Biomes.HAS_GREEN_AERCLOUDS),
                HolderSet.direct(context.lookup(Registries.PLACED_FEATURE).getOrThrow(GenesisPlacedFeatures.GREEN_AERCLOUD_8_PLACEMENT)),
                GenerationStep.Decoration.TOP_LAYER_MODIFICATION
        ));
        context.register(ADD_PURPLE_AERCLOUD, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_STORM_AERCLOUD, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_ORANGE_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_GROVE_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_WOODLAND_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_FOREST_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_CONTINUUM_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SPAWN_TEMPEST, new BiomeModifiers.AddSpawnsBiomeModifier(
