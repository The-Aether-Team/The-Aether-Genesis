...
public class GenesisFeatureStates {
    ...
    public static final BlockState SKYROOT_LOG_WALL = BeyondParityBlocks.SKYROOT_LOG_WALL.get().defaultBlockState().setValue(AetherBlockStateProperties.DOUBLE_DROPS, true);
