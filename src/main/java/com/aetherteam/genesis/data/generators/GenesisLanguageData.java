...
public class GenesisLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addLore(GenesisItems.CORNSTARCH_BOWL, "");
        this.addLore(GenesisItems.CONTINUUM_ORB, "");
        this.addLore(GenesisItems.BLUE_SWET_JELLY, "");
        this.addLore(GenesisItems.GOLDEN_SWET_JELLY, "");
        this.addLore(GenesisItems.DARK_SWET_JELLY, "");
        this.addLore(GenesisItems.DARK_GUMMY_SWET, "A minty-tasting gummy, it can be found in random chests in Bronze and Silver Dungeons. It fully restores the player's hunger when eaten. Very useful for boss fights.");
        this.addLore(GenesisItems.ICESTONE_POPROCKS, "");
        this.addLore(GenesisItems.COCOATRICE, "");
        this.addLore(GenesisItems.WRAPPED_CHOCOLATES, "");
        this.addLore(GenesisItems.BLUEBERRY_LOLLIPOP, "");
        this.addLore(GenesisItems.ORANGE_LOLLIPOP, "");
        this.addLore(GenesisItems.STOMPER_POP, "");
        this.addLore(GenesisItems.ORANGE, "");
        this.addLore(GenesisItems.WYNDBERRY, "");
        this.addLore(GenesisItems.JELLY_PUMPKIN, "");
        this.addLore(GenesisItems.CANDY_CORN, "");
        this.addLore(GenesisItems.RAINBOW_STRAWBERRY, "");
        this.addLore(GenesisItems.BONE_RING, "");
        this.addLore(GenesisItems.CANDY_RING, "");
        this.addLore(GenesisItems.SKYROOT_RING, "");
        ...
        this.addLore(GenesisItems.PHOENIX_DART_SHOOTER, "");
        ...
        this.addLore(GenesisItems.BLUE_PARACHUTE, "");
        this.addLore(GenesisItems.GREEN_PARACHUTE, "");
        this.addLore(GenesisItems.PURPLE_PARACHUTE, "");
        ...
        this.addLore(GenesisBlocks.GREEN_AERCLOUD, "");
        this.addLore(GenesisBlocks.PURPLE_AERCLOUD, "");
        this.addLore(GenesisBlocks.STORM_AERCLOUD, "A dark, dim cloud found low in the Aether. Some say this is where Tempests originate from at nightfall.");
        this.addLore(GenesisBlocks.CONTINUUM_ORE, "");
        this.addLore(GenesisBlocks.BLUE_SKYROOT_LEAVES, "");
        this.addLore(GenesisBlocks.DARK_BLUE_SKYROOT_LEAVES, "");
        this.addLore(GenesisBlocks.PURPLE_CRYSTAL_LEAVES, "");
        this.addLore(GenesisBlocks.PURPLE_CRYSTAL_FRUIT_LEAVES, "");
        this.addLore(GenesisBlocks.ORANGE_TREE, "");
        ...
        this.addLore(GenesisBlocks.DARK_BLUE_SKYROOT_SAPLING, "");
        this.addLore(GenesisBlocks.PURPLE_CRYSTAL_TREE_SAPLING, "");
        ...
        this.addLore(GenesisBlocks.SKYROOT_CRAFTING_TABLE, "");
        this.addLore(GenesisBlocks.HOLYSTONE_FURNACE, "");
        this.addLore(GenesisBlocks.SKYROOT_CHEST, "");
        this.addLore(GenesisBlocks.SKYROOT_LADDER, "");
        ...
        this.addLore(GenesisBlocks.DIVINE_CARVED_STONE, "");
        this.addLore(GenesisBlocks.DIVINE_SENTRY_STONE, "");
