...
public class GenesisLanguageData extends AetherLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addLore(GenesisItems.BONE_RING, "A ring made from bone and carved with spiky protrusions. It grants the wearer extra attack damage.");
        ...
        this.addLore(GenesisItems.FLEETING_STONE, "A stone covered in glowing green runes. It activates into a wisp that makes your legs stronger, therefore they can walk up blocks instantly.");
        this.addLore(GenesisItems.SOARING_STONE, "A stone covered in glowing blue runes. It activates into a wisp that makes your legs stronger, allowing them to run at a faster speed.");
        ...
        this.addLore(GenesisItems.FROSTPINE_TOTEM, "A totem carved with the visages of a Moa, a Gruegar, and a Zephyr. It grants the wearer the ability to see in the dark; useful for finding ores under islands!");
        this.addLore(GenesisItems.FROSTBOUND_STONE, "A stone covered in frost, that activates into a sprite that generates up to 16 snowballs in your inventory. This pairs well with the Daggerfrost Locket.");
