...
public class Kraisith extends CompanionMob implements Combative, RangedAttackMob { //todo ranged?
...
//        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, (), 6.0F, (double)1.0F, 1.2)); //todo move away from the enemy to shoot.
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        PoisonNeedle needle = new PoisonNeedle(this.level(), this); //todo enchanted dart
