...
public class SentryGolemLayer extends EyesLayer<SentryGolem, SentryGolemModel> {
    private static final RenderType SENTRY_GOLEM_GLOW = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/sentry_golem/sentry_golem_glow.png"));
