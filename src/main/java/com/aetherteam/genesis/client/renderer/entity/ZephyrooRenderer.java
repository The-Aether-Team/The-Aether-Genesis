...
public class ZephyrooRenderer extends MobRenderer<Zephyroo, ZephyrooModel<Zephyroo>> { //todo old variant
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/zephyroo/zephyroo.png");
