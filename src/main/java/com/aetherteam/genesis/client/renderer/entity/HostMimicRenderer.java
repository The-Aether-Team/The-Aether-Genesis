...
public class HostMimicRenderer extends MobRenderer<SliderHostMimic, SliderHostMimicModel> {
    private static final ResourceLocation HOST_MIMIC_ASLEEP_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/slider_host_mimic/slider_host_mimic_asleep.png");
    private static final ResourceLocation HOST_MIMIC_AWAKE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/slider_host_mimic/slider_host_mimic_critical.png");
