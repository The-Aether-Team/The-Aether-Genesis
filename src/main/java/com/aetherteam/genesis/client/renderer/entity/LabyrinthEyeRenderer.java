...
public class LabyrinthEyeRenderer extends MobRenderer<LabyrinthEye, LabyrinthEyeModel> {
    private static final ResourceLocation LABYRINTH_EYE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/labyrinth_eye/labyrinth_eye_sleep.png");
    private static final ResourceLocation LABYRINTH_EYE_AWAKE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/labyrinth_eye/labyrinth_eye_awake.png");
