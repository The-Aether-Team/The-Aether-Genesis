...
public class TrackingGolemLayer extends EyesLayer<TrackingGolem, TrackingGolemModel> {
	private static final RenderType TRACKING_GOLEM_GLOW = RenderType.eyes(new ResourceLocation(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/tracking_golem_glow.png"));
	private static final RenderType TRACKING_GOLEM_HOSTILE_GLOW = RenderType.eyes(new ResourceLocation(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/tracking_golem_hostile_glow.png"));
