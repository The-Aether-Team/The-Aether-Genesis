...
public class NexSpiritRenderer extends CompanionRenderer<NexSpirit, NexSpiritModel> {
    private static final ResourceLocation NEX_SPIRIT_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit.png");
    private static final ResourceLocation NEX_SPIRIT_BROKEN_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_broken.png");
    private static final ResourceLocation NEX_SPIRIT_ANGERED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_angered.png");
    private static final ResourceLocation NEX_SPIRIT_CONFUSED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_confused.png");
    private static final ResourceLocation NEX_SPIRIT_FLUSHED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_flushed.png");
    private static final ResourceLocation NEX_SPIRIT_NAUSEATED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_nauseated.png");
    private static final ResourceLocation NEX_SPIRIT_SADDENED_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_saddened.png");
    private static final ResourceLocation NEX_SPIRIT_SUSPICIOUS_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/nex_spirit/nex_spirit_suspicious.png");
