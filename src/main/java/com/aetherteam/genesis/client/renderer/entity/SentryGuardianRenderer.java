...
public class SentryGuardianRenderer extends MobRenderer<SentryGuardian, SentryGuardianModel> {
    ...
    private static final ResourceLocation SENTRY_GUARDIAN_AWAKE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/sentry_guardian/sentry_guardian_critical.png");
