...
public class TrackingGolemRenderer extends MobRenderer<TrackingGolem, TrackingGolemModel> {
    public static final ResourceLocation TRACKING_GOLEM_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/tracking_golem.png");
    public static final ResourceLocation TRACKING_GOLEM_HOSTILE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/tracking_golem_hostile.png");
