...
public class TrackingGolemRenderer extends MobRenderer<TrackingGolem, TrackingGolemModel> {
    private static final ResourceLocation TRACKING_GOLEM_TEXTURE = new ResourceLocation(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/sentry_golem.png");
    private static final ResourceLocation TRACKING_GOLEM_HOSTILE_TEXTURE = new ResourceLocation(AetherGenesis.MODID, "textures/entity/mobs/tracking_golem/sentry_golem_hostile.png");
