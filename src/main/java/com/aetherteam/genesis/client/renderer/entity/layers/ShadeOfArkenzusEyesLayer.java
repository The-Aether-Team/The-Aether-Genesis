...
public class ShadeOfArkenzusEyesLayer extends EyesLayer<ShadeOfArkenzus, ShadeOfArkenzusModel> {
    private static final RenderType SHADE_OF_ARKENZUS_GLOW = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/companions/shade_of_arkenzus/shade_of_arkenzus_emissive.png"));
