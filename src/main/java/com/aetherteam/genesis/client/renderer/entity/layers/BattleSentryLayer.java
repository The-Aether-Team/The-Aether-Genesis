...
public class BattleSentryLayer extends EyesLayer<BattleSentry, SlimeModel<BattleSentry>> {
	private static final RenderType BATTLE_SENTRY_EYE = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/battle_sentry/eye.png"));
