...
public class TempestMarkingsLayer extends EyesLayer<Tempest, TempestModel> {
    private static final RenderType TEMPEST_GLOW = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/entity/mobs/tempest/tempest_emissive.png"));
