...
public class HolystoneFurnaceScreen extends AbstractFurnaceScreen<HolystoneFurnaceMenu> {
	private static final ResourceLocation FURNACE_GUI_TEXTURES = ResourceLocation.fromNamespaceAndPath(AetherGenesis.MODID, "textures/gui/menu/holystone_furnace.png");
